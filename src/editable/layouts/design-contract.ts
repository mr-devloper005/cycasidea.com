...
export const editableRootStyle = {
  // Cycasidea directory system: clean white surfaces, blue accents,
  // pale information bands, and fine borders.
  '--slot4-page-bg': '#ffffff',
  '--slot4-page-text': '#162033',
  '--slot4-panel-bg': '#f7fbff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#657184',
  '--slot4-soft-muted-text': '#8a96a7',
  '--slot4-accent': '#3d73cf',
  '--slot4-accent-fill': '#2f6bc8',
  '--slot4-accent-soft': '#eaf3ff',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#162033',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#d8e7f7',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f7fbff',
  ...
  '--editable-page-text': '#162033',
  '--editable-container': '1180px',
  '--editable-border': '#dbe5f2',
  '--editable-nav-bg': 'rgba(22,32,51,0.72)',
  '--editable-nav-text': '#ffffff',
  '--editable-nav-active': '#3d73cf',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#3d73cf',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#477dcc',
