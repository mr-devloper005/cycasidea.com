export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'cycasidea',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Cycasidea',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'cycasidea.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://cycasidea.com',
